...
class OOPArtNet(nn.Module):
    def __init__(self):
        super().__init__()

        #最初の2層
        self.conv1 = nn.Conv2d(4, 64, kernel_size=(7, 7), stride=(2, 2), padding=3)
...
class GlobalAvgPool2d(nn.Module):
    ...
    def forward(self, x):
        ...
        return F.avg_pool2d(x, kernel_size=[5, 4]).view(-1, x.size(1))